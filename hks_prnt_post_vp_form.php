...
if ($result_all->num_rows > 0) {
  ...
  $vpno=substr($row["VPNo"],2);
           ...
           <h4 style="font-size:20px; text-align: left; font-weight: bold;">ভিপি মূল্য: ('.$new_num.'/-) <span id="w'.$row["transid"].'" ></span></h4> <br><br>
        ...
        <span style="font-size:30px; text-align: left;  font-weight: bold; "> &nbsp  &nbsp &nbsp   &nbsp  &nbsp &nbsp &nbsp      VP:'.$vpno.'</span><br> 
        ...
        ডাকঃ '.id_po_bn($row["transid"]).",থানাঃ ".ps_en_bn(id_ps($row["transid"])).', <br>
         জেলা: '.dist_en_bn(id_dist($row["transid"])).' <br>
           ...
           <div style="font-size:18px; font-weight: bold;     ">বই-'.number_en_bn($journal).'</div>
