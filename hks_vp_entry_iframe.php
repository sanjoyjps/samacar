...
$sql_all = "SELECT idn,cust_name,transid,Dr,VPNo,vername,cust_id,phone,total_donation,paid,due,transaction_id,Rdate,vername,agcpy,Comment,address,donation FROM tblIssue  where  sent_mode='vp' and vername=".$issue_no." order by cast(agcpy as UNSIGNED) asc ";
...
if ($result_all->num_rows > 0) {
	...
	echo '
<form class="cl_form" method ="post"  action="hks_vp_entry_data.php">';
