...
<body>
  ...
  <!-- End of Report Print -->
			        ...
			        <div class="col-sm-12 col-md-12  contact-form" style="background-color: #ffd7eb;"> <!-- div da direita -->
                        <form id="contact" method="post" class="form" target="hks_vp_entry_iframe" action="hks_vpp_entry_iframe.php" role="form">
                                ...
                                <div class="col-xs-4 col-md-4 form-group" >
                                <div class="form-group row">
                                    <label for="isn" class="col-sm-4 col-form-label" style="font-size: 18px; font-weight: bold;">VP Range</label>
                                    <div class="col-sm-8" >
                                    <input type="text" class="form-control" id ="isn" name="vp_range" placeholder="VP Range" required >
                                    </div>
                                </div>
                                </div>
 			...
 			<div class="table-responsive">
                ...
                <iframe name="hks_vp_entry_iframe"height="350" width=100%  style="border:0" style="overflow-y:scroll; overflow-x:scroll;"></iframe>
