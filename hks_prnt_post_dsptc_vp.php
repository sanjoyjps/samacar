...
mysqli_set_charset($conn_all,"utf8");
   $sql_all = "SELECT transid,vername,VPNo,transaction_id, SentDate,agcpy ,transid  FROM tblIssue where (transid >99 AND transid <10000 AND sent_mode='vp' and despatch =".$g." AND vername =".$print_issue." ) order by cast(VPNo as unsigned) ";
