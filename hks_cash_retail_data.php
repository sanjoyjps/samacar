...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO tblIssue (cust_name,cust_id,phone,total_donation,paid,due,transaction_id,Rdate,vername,agcpy,Comment,address,donation,user,news_rate,news_price)
    VALUES (:cust_name,:cust_id,:phone,:total_donation,:paid,:due,:transaction_id,:Rdate,:vername,:agcpy,:Comment,:address,:donation,:user,:news_rate,:news_price)");
