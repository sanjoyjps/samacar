...
<div id="wrapper" class="col-md-2 col-xl-2">
  ...
  <!-- Sidebar -->
   ...
   <div id="accordion">
    ...
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" href="#collapseTwo"> Agent </a>
      </div>
...
<div class="col-md-10 col-xl-10">
      ...
      <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            <div class="row">
              <div class="col-md-12">
              <p class="well lead" style="text-align:center;margin-top: 5px;" > Subscriber Book </p>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 contact-form"> <!-- div da direita -->
                        <form id="ag_submit" method="post" class="form" role="form" target='iframe_subs_book'  action="subs_book_search.php">
    								    <div class="row">
                        <div class="col-sm-8">
                        <input class="form-control" id="ag_input" name="ag_search" placeholder="Type  to Search" type="text"  onkeyup="agBookSearch00000()"/>
                        </div>
                        <div class="col-sm-4">
				...
				<iframe name='iframe_subs_book' height=135% width=100%   style="border:0"></iframe> 
	 
			<iframe name='iframe_subs_book_individual_summary' height="300" width=100%   style="border:0"></iframe> 
