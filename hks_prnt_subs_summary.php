...
<h5> মাসিক হরেকৃষ্ণ সমাচার - SBS <?php echo $print_issue; ?></h5></div>


<table style="width:100%" >
<tr><th>SL</th><th>VPNo.</th><th>AGN</th><th>নাম</th><th>জেলা</th><th>মোবাইল</th><th>Balance</th></tr>
...
echo'<tr><td>'.$p.'</td><td>'.substr($row["VPNo"],2).'</td><td>'.$row["transid"].'</td><td>'.id_name($row["transid"]).'</td><td>'.dist_en_bn(id_dist($row["transid"])).'</td><td>'.id_phone($row["transid"]).'</td><td>'.id_balance($row["transid"]).'</td></tr>
