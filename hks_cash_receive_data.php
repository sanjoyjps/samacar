...
echo"<hr>";
  ...
  */
  ...
  $stmt = $conn->prepare("update tblIssue set VPNo=:VPNo,Dr=:Dr,Returned=:Returned,RDate=:RDate , user =:user,comment=:comment where transaction_id=:transaction_id  AND transaction_id>0");
