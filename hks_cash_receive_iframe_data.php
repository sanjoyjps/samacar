...
$sql_all = "SELECT idn,cust_name,transid,Dr,VPNo,Returned,vername,cust_id,phone,total_donation,paid,due,transaction_id,Rdate,vername,agcpy,Comment,address,donation FROM tblIssue  where ( transid<10000 AND vername=".$cash_issue.")";
...
<td><input type="date"   name="vp_date" style="background-color: transparent; width:180px; text-align:center;" value="'.$row['Rdate'].'"></td>

<td><input type="input" name="vp_no" style="background-color: transparent; width:100px; text-align:center;" value="'.$row["VPNo"].'"></td>
 
<td><input type="input" name="vp_receive" style="background-color: transparent; width:100px; text-align:center;" value="'.$row["Dr"].'"></td>
<td> 
