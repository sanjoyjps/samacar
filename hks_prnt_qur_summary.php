...
<tr><th>SL</th> <th>নাম</th><th>Barcode</th><th>মোবাইল</th><th>পরিমাণ</th><th>কন্ডি.</th><th>কুরিয়ার</th><th style="width:1.5in">রসিদ</th><th>তারিখ </th></tr>
<?php 
...
if ($result_all->num_rows > 0) {
 ...
 <td>'.id_phone($row["transid"]).'</td><td>
 '.$row["agcpy"].'</td><td>'.intval(doubleval($row["agcpy"])*doubleval(id_news_rate($row["transid"]))).'
 </td><td style="text-align:left">'.id_cour_name($row["transid"]).'-'.id_courier_description($row["transid"]).'</td>
 <td style="width:1.0in">'.$row["VPNo"].'</td>
 <td style="width:1.0in"></td></tr>
