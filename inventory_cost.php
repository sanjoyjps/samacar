...
<h3 style="text-align: center;">Issue   '.$issue.'</h3> <br> 
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input class="form-control" type="text" name="received_qty" value="'.$row["received_qty"].'"class="form-control" id="validationCustom01" required>
	  <div class="invalid-feedback">Please provide valid data.</div>
    </div>
     <div class="col-md-4 mb-3">
      <label for="validationCustom02">Received Date</label>
      <input class="form-control"   type="date" name="received_date" value="'.$row["received_date"].'" class="form-control" id="validationCustom02" required>
	  <div class="invalid-feedback">Please provide valid data.</div>
    </div>
	<div class="col-md-4 mb-3">
      <label for="validationCustom03">Others (Wastage/Lost</label>
      <input class="form-control" type="text" class="form-control" name="wastage" value="'.$row["wastage"].'" id="validationCustom03" required>
	  <div class="invalid-feedback">Please provide valid data.</div>
    </div>
  </div>
