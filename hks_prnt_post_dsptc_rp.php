...
<div class="page">
  ...
  <div class="row">
    <div style="text-align:center;" class="col-sm-6"  > <br>
        ...
        px;position: absolute;top: 8px;right: 80px;">Despatch-'.$g.'</span>  
      <h6> ঢাকা সদর <br> <br> আরপি </h6></div>	
      ...
      <br>     <br>
		...
		echo '
            <tr>
         <td>'.substr($arr_vp[$b-1],2).'</td>  <td>'.substr($arr_vp[$half_val+$b-1],2).'</td> 
            
        <td>'.substr($arr_vp[2*$half_val+$b-1],2).'</td> <td>'.substr($arr_vp[3*$half_val+$b-1],2).'</td> 
            
          <td>'.substr($arr_vp[4*$half_val+$b-1],2).'</td>  <td>'.substr($arr_vp[5*$half_val+$b-1],2).'</td> 
            
            <td>'.substr($arr_vp[6*$half_val+$b-1],2).'</td>  <td>'.substr($arr_vp[7*$half_val+$b-1],2).'</td> 
