...
#error {
 ...
 .googlemap{width:100%; position:absolute; height:500px; left:0px; }
...
<body>
 ...
 <nav class="navbar navbar-expand-sm bg-light navbar-light sticky-top">
  <a class="navbar-brand" href="#"><img src="front_images/hklogo.gif" height="80" width="80" alt="HKS"></a>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="hkp_images/base1.jpg" alt="First slide">
        ...
        <div class="carousel-item" >
            <img class="d-block w-100" src="hkp_images/base2.jpg" alt="Second slide" style="position: relative;">
            	<div class="row" style="    float: left;    position: absolute;    left: 200px;    top: 300px;    background-color: ;">
              <div class="col-md-4">
                <a class="thumbnail" href="#"><img alt="" src="hkp_images/1.jpg" width="200" height="250" style="border:3px solid white"></a>
                <h6 style="color: white; text-align: center;">Death</h6>
              </div>          
              <div class="col-md-4">
                <a class="thumbnail" href="#"><img alt="" src="hkp_images/2.jpg" width="200" height="250" style="border:3px solid white"></a>
                <h6 style="color: white; text-align: center;" >Prakrita Sukh Kothai</h6>
              </div>
              <div class="col-md-4">
                <a class="thumbnail" href="#"><img alt="" src="hkp_images/3.jpg" width="200" height="250" style="border:3px solid white"></a>
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="hkp_images/base3.jpg" alt="Third slide">
         ...
         <div class="carousel-item">
            <img class="d-block w-100" src="hkp_images/base4.jpg" alt="Third slide">
      ...
      <div class="black-footer">
        ...
        <div class="container" style="color: black;" >
            <div class="row">
                ...
                <p><img src="front_images/hklogo.gif" height="120" width="120" alt="HKS"></p>
