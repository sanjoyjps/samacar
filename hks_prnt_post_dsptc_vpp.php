...
mysqli_set_charset($conn_all,"utf8");
   $sql_all = "SELECT transid,vername,VPNo,transaction_id, SentDate,agcpy ,transid FROM tblIssue where (transid >99 AND  sent_mode='vpp' and  transid <10000 AND despatch =".$g." AND vername =".$print_issue." ) order by cast(VPNo as unsigned) ";
  ...
  <div class="row">
    <div class="col-sm-6"  > <br>
        ...
        px;position: absolute;top: 8px;right: 25px;">Despatch-'.$g.'</span>
			...
			<h6> ঢাকা সদর <br> <br> ভিপিপি </h6></div>		
		<table style="width:100%" >
		<tr><th>SL</th><th>VPP</th><th>নাম</th><th>SL</th><th>VPP</th><th>নাম</th></tr>
		';
